...
genai.configure(api_key="AIzaSyAse6APUIdGOZMC2gsGJtwuKCxO_9maX6E")
...
def run_comparisons_in_batches_v2(responses_dir, vectorstore_context, max_pathologies=None, skip=0):
    output_dir = "docs/comparisons_gemini20"
...
responses_dir = "docs/respuestas_generadas_contexto20"
max_pathologies = 1
skip = 0
#run_comparisons_in_batches_v2(responses_dir, vectorstore, max_pathologies=5, skip=0)
#run_comparisons_in_batches_v2(responses_dir, vectorstore, max_pathologies=5, skip=5)
# run_comparisons_in_batches_v2(responses_dir, vectorstore, max_pathologies=5, skip=10)
run_comparisons_in_batches_v2(responses_dir, vectorstore, max_pathologies=5, skip=15)
